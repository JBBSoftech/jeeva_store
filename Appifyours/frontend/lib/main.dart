...
class ApiConfig {
  ...
  static const String adminObjectId = '694b7e6d926068088f890b39'; // Will be replaced during publish
...
class AdminManager {
  ...
  static Future<String?> _autoDetectAdminId() async {
    try {
      final response = await http.get(
        Uri.parse('http://10.22.120.184:5000/api/admin/app-info'),
        headers: {'Content-Type': 'application/json'},
      );
  ...
  Future<void> _signIn() async {
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse('http://10.22.120.184:5000/api/login'),
        headers: {'Content-Type': 'application/json'},
        body: json.encode({
