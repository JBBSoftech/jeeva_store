...
// MongoDB connection
mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/jeeva_store_app', {
...
app.get('/api/app-config', async (req, res) => {
  try {
    ...
    const config = {
      adminId: '694b7e6d926068088f890b39',
      shopName: 'Jeeva Store',
...
app.listen(PORT, () => {
  console.log(`Jeeva Store Backend Server running on port ${PORT}`);
});
